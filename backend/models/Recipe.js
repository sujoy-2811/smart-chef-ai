...
class Recipe {
            ...
            if(nutrition && Object.keys(nutrition).length > 0) {
                const nutritionResult = await client.query(
                    `INSERT INTO recipe_nutrition (recipe_id, calories, protein, carbs, fats, fiber)
                     VALUES ($1, $2, $3, $4, $5, $6)`, [recipe.id, nutrition.calories || 0, nutrition.protein || 0, nutrition.carbs || 0, nutrition.fats || 0, nutrition.fiber || 0]
                );
            }
    ...
    static async findByUserId(userId, filters = {}) {
        let query = `SELECT r.*, rn.colores FROM recipes r
