                    ...
                    >
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sky-800 text-sm">Create AI-powered recipes</p>
                            </div>
                        </div>
                    </Link>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white/90 rounded-xl border border-sky-100 p-6">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <Link to="/recipes" className="text-sm text-sky-600 hover:text-sky-700 font-medium">
                                View all
                            </Link>
                        </div>
                    ...
                    <div className="bg-white/90 rounded-xl border border-sky-100 p-6">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <Link to="/meal-plan" className="text-sm text-sky-600 hover:text-sky-700 font-medium">
                                View calendar
                            </Link>
                        </div>
